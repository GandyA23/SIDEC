            ...
            <div class=" row d-flex bg-redDark align-items-center justify-content-center mx-auto" style="height: 50%; width: 75%; border-radius: 30px;">
                ...
                <div class="col-sm-4 m-3 bg-white mx-auto" style="height: 45%; width: 90%; border-radius: 30px;">
                    <form>
                        ...
                        <br>
                        <div class="p-2">
                            <input type="text" class="form-control text-center" placeholder="CCT" style="border-radius:10px;">
                        </div>
                        <div class="p-2">
                            <input type="password" class="form-control text-center" placeholder="Contraseña" style="border-radius:10px">
                        </div>
                        <div class="d-flex justify-content-center">
                            <a href="" style="color: #C41414; text-align: center;">Olvidé mi contraseña</a>
                        </div>
                        <br>
                        <div class="p-3">
                            <button type="button" class="btn btn-danger btn-sm btn-block" style="border-radius:10px; color: white">Ingresar</button>
                        </div>
                    </form>
                </div>
