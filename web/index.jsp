...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <meta name="author" content="Jair David V.M">
            ...
            <div class=" row d-flex bg-redDark align-items-center justify-content-center mx-auto" style="height: 50%; width: 75%; border-radius: 30px;">
                ...
                <div class="col-sm-4 m-3 bg-white mx-auto" style="height: 45%; width: 90%; border-radius: 30px;">
                    ...
                    <form method="post" action="<%=request.getContextPath()%>/LoginServlet">
                        ...
                        <div class="p-2">
                            <input type="text" name="cct" class="form-control text-center" placeholder="CCT" style="border-radius:10px;">
                        </div>
                        <div class="p-2">
                            <input type="password" name="password" class="form-control text-center" placeholder="Contraseña" style="border-radius:10px">
                        </div>
                        <div class="d-flex justify-content-center">
                            <a href="" style="color: #c41414; text-align: center;" onclick="atencion()">Olvidé mi contraseña</a>
                        </div>
                        <br>
                        <div class="p-3">
    ...
    <script>
        function atencion() {
            alert("Dirigete con el administrador para que restablezca tu contraseña");
        }
    </script>
