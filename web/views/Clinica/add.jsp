...
<div class="container" id="page-content-wrapper">
    ...
    <div class="container">
        <form action="${pageContext.request.contextPath}/ClinicaServlet" method="post">
            ...
            <div class="row form-group">
                <div class="col">
              <textarea class="form-control" name="diagPsico"  rows="2" placeholder="Diagnóstico psicopedagógico"></textarea>
                </div>
            </div>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-5">
                    <button type="submit" class="btn bg-danger btn-sm btn-block text-white" name="accion" value="add"><b>Añadir</b></button>
                </div>
            </div>
        </form>
    </div>
