...
<div class="container" id="page-content-wrapper">
			...
			<div class="row form-group">
				...
				<div class="col">
					<input type="text" name="numeroSeguro" class="form-control  text-center"
					       value="<c:out value="${clinica.numeroSeguro}"/>" maxlength="20" placeholder="Número Seguro Médico" required>
				</div>
				<div class="col">
					<input type="text" name="unidadMedica" class="form-control  text-center"
					       value="<c:out value="${clinica.unidadMedica}"/>" maxlength="10" placeholder="Unidad médica" required>
				</div>
			</div>
	...
	<div class="row form-group">
		<div class="col">
              <textarea class="form-control" name="diagPsico" id="exampleFormControlTextarea1" rows="2" placeholder="Diagnóstico psicopedagógico"><c:out value="${clinica.diagPsico}"/></textarea>
		</div>
	</div>
	<div class="container-fluid text-center">
		...
		<div class="row form-group">
			<div class="col">
				...
				<div class="col">
					<textarea class="form-control" name="enferCronicas2" rows="2" placeholder="Descripción:"><c:out
							value="${clinica.enferCronicas}"/></textarea>
				</div>
			</div>
		...
		<div class="row d-flex justify-content-center">
			<div class="col-md-4">
				<button onclick="pregunta()" type="button" class="btn bg-danger btn-block text-white"><b>Actualizar</b>
