	...
	<form class="container">
		...
		<div class="form-row justify-content-around">
			<div class="col-md-4 bg-gris text-center" style="border-radius: 7px;">
				<b style="color:white;">Eliminar Estudiante</b>
			</div>
			...
			<div class="col-11">
				<div>
					<div class="row justify-content-center">
						<button type="submit" class="btn btn-primary btn-lg bg-danger" name="listener" value="eliminar" style="width: 40%">Eliminar
						</button>
					</div>
				</div>
			</div>
